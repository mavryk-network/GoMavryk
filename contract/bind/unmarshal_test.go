...
var testAddress = mavryk.MustParseAddress("mv1CQJA6XDWcpVgVbxgSCTa69AW1y8iHbLx5")
...
func TestUnmarshalPrim(t *testing.T) {
	cases := map[string]struct {
		...
		"address":       {prim: micheline.NewString(testAddress.String()), dst: mavryk.Address{}, want: testAddress},
