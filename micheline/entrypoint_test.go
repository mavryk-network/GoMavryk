...
var entryInfo = []entryTest{
	...
	// quipuswap %use
	{
		...
		Want: `{
			...
			"transfer": {"branch": "/L/R/R","id": 3,"name": "transfer","type": [{"args": [{"args": [{"name": "from_","path": [0,0],"type": "address"},{"args": [{"args": [{"name": "to_","path": [0,1,0,0],"type": "address"},{"name": "token_id","path": [0,1,0,1,0],"type": "nat"},{"name": "amount","path": [0,1,0,1,1],"type": "nat"}],"name": "@item","path": [0,1,0],"type": "struct"}],"name": "txs","path": [0,1],"type": "list"}],"name": "@item","path": [0],"type": "struct"}],"name": "","path": [],"type": "list"}]},
			"update_operators": {"branch": "/R/L","id": 4,"name": "update_operators","type": [{"args": [{"args": [{"args": [{"name": "owner","path": [0,0,0],"type": "address"},{"name": "operator","path": [0,0,1,0],"type": "address"},{"name": "token_id","path": [0,0,1,1],"type": "nat"}],"name": "add_operator","path": [0,0],"type": "struct"},{"args": [{"name": "owner","path": [0,1,0],"type": "address"},{"name": "operator","path": [0,1,1,0],"type": "address"},{"name": "token_id","path": [0,1,1,1],"type": "nat"}],"name": "remove_operator","path": [0,1],"type": "struct"}],"name": "@item","path": [0],"type": "union"}],"name": "","path": [],"type": "list"}]},
