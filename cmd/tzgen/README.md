...
```bash
go install github.com/mavryk-network/gomavryk/cmd/tzgen
```

## Using TzGen

When using TzGen you don't have to worry about details of Micheline or GoMavryk. TzGen produces all interfaces and types you'll need to call any of your contract's entrypoints, read its storage and bigmap entries.
...
```
//go:generate go run -mod=mod github.com/mavryk-network/gomavryk/cmd/tzgen -name <name> -pkg <pkg> -address <addr> -out <file.go>
```
