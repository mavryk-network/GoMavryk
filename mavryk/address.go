...
// AddressType represents the type of a Mavryk signature.
...
// MarshalBinary outputs the 21 byte GoMavryk version of an address containing
// a one byte type tag and the 20 byte address hash.
func (a Address) MarshalBinary() ([]byte, error) {
	return a[:], nil
}

// UnmarshalBinary reads the 21 byte GoMavryk version of an address containing
// a one byte type tag and the 20 byte address hash.
