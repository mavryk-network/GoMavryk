...
Use GoMavryk to produce any type of Mavryk operation. One by one, this example shows all the basic steps to make, encode, simulate, sign, broadacst and wait for operation to be confirmed .
